  ...
  return (
    <>
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 pb-16 bg-[#F6F7FB]">
        <div className="max-w-[1100px] mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 py-8 border-y border-[#15122E]/10">
          {stats.map((s, i) => (
            <motion.div
              key={s.label}
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-16 bg-[#F6F7FB]">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="max-w-[560px] mx-auto font-['DM_Sans'] text-[#15122E]/65 text-[16px] sm:text-lg">
            ...
            {values.map((v, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-6 sm:p-8 rounded-[24px] sm:rounded-[28px] border border-[#15122E]/10 bg-white hover:border-[#6C63FF]/40 transition-colors"
                >
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-16 lg:py-24 bg-white">
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="font-onest text-[24px] sm:text-[30px] lg:text-[40px] font-semibold text-[#15122E] tracking-[-0.8px] sm:tracking-[-1px] mb-5">
              Enterprise-grade, fully managed
            </h2>
            <p className="font-['DM_Sans'] text-[16px] sm:text-lg text-[#15122E]/65 mb-6">
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-16 lg:py-24 bg-[#F6F7FB]">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="max-w-[600px] mx-auto font-['DM_Sans'] text-[#15122E]/65 text-[16px] sm:text-lg">
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 pb-24 bg-[#F6F7FB]">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 max-w-[420px] sm:max-w-none mx-auto">
            <Link
              href="/contact"
            ...
            <Link
              href="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 h-12 px-8 rounded-full border border-white/40 text-white font-poppins font-semibold hover:bg-white/10 transition-colors"
            >
              Talk to Sales
            </Link>
          </div>
