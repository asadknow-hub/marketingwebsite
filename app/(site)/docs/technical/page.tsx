    ...
    <>
            ...
            {architecture.map((a, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="font-['DM_Sans'] text-[14px] leading-relaxed text-[#15122E]/65">
                    {a.desc}
                  </p>
                </motion.div>
              );
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-16 bg-white">
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="rounded-[28px] border border-[#15122E]/10 bg-white overflow-hidden divide-y divide-[#15122E]/8">
            {apis.map((a, i) => (
              <motion.div
                key={a.path + a.method}
                initial={{ opacity: 0 }}
              ...
              >
                <span
                  className={
                    ...
                    (methodColor[a.method] || "bg-[#15122E]/8 text-[#15122E]")
                  }
                >
                  {a.method}
                </span>
                <code className="font-mono text-[14px] text-[#15122E] shrink-0">{a.path}</code>
                <span className="font-['DM_Sans'] text-[14px] text-[#15122E]/50 sm:ml-auto sm:text-right">
                  {a.desc}
                </span>
              </motion.div>
            ))}
