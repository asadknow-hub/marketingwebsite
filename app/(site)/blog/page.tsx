    ...
    <>
      ...
      >
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            className="w-full h-12 pl-11 pr-4 rounded-full border border-[#15122E]/10 bg-white/80 font-['DM_Sans'] text-[#15122E] placeholder:text-[#15122E]/40 outline-none focus:border-[#6C63FF] focus:ring-2 focus:ring-[#6C63FF]/20 transition-all"
          />
        </div>
      </PageHero>
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 pb-24 bg-[#F6F7FB]">
        <div className="max-w-[1200px] mx-auto">
            ...
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={
                  ...
                  (category === cat
                    ? "text-white"
                    : "text-[#15122E]/60 hover:text-[#15122E] bg-[#15122E]/[0.04]")
                }
              >
                {category === cat && (
                  <motion.span
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20 text-[#15122E]/40">
                      ...
                      <div className="flex items-center justify-between gap-2 mb-3 flex-wrap">
                        <span
                          className={
                            ...
                            (CAT_COLOR[post.category] || "bg-[#15122E]/[0.04] text-[#15122E]/60")
                          }
                        >
                          {post.category}
                        </span>
                        <span className="text-xs text-[#15122E]/40 font-['DM_Sans'] flex items-center gap-1">
                          <Calendar className="w-3 h-3" />
                          {formatDate(post.publishedAt)}
                        </span>
                      </div>
                      <h3 className="font-onest text-lg font-semibold text-[#15122E] mb-2 leading-snug tracking-[-0.3px]">
                        {post.title}
                      </h3>
                      <p className="font-['DM_Sans'] text-[15px] text-[#15122E]/65 leading-relaxed mb-4 flex-1">
                        {post.excerpt}
                      </p>
