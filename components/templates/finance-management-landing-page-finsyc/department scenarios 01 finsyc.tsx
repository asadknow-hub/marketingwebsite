    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="font-poppins text-[11px] font-bold uppercase tracking-[0.28em] text-[#6C63FF]">
            {department}
          </p>
          <h3 className="mt-1 font-onest text-[22px] sm:text-[26px] font-semibold leading-tight tracking-[-0.8px] text-[#15122E]">
            {title}
          </h3>
...
const agentBlocks = [
  ...
  { label: "5 hours back, every day", weight: 5, tone: "border border-dashed border-[#6C63FF]/40 bg-white text-[#6C63FF]" },
];
...
export default function DepartmentScenarios01Finsyc({ className }: { className?: string }) {
  ...
  return (
    <>
      <section className={"relative w-full overflow-hidden bg-[#F6F4FF] py-20 lg:py-28 " + (className || "")}>
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-32 right-[-120px] h-[420px] w-[420px] rounded-full bg-[#6C63FF]/10 blur-[140px]" />
          <div className="absolute bottom-[-140px] left-[-100px] h-[360px] w-[360px] rounded-full bg-[#4F46E5]/10 blur-[120px]" />
        </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.96fr_1.04fr] items-start">
            <div className="lg:sticky lg:top-24 self-start">
              ...
              <motion.h2
                ...
                className="mt-6 max-w-[660px] font-onest text-[38px] sm:text-[48px] lg:text-[64px] font-semibold leading-[0.96] tracking-[-2px] text-[#15122E]"
              >
              ...
              <motion.p
                ...
                className="mt-5 max-w-[620px] font-['DM_Sans'] text-[18px] sm:text-[20px] leading-relaxed text-[#15122E]/80"
              >
              ...
              <div className="mt-10 space-y-6">
                ...
                >
                  <div className="flex items-center justify-between gap-4 mb-3">
                    <span className="font-poppins text-[11px] sm:text-[12px] font-bold uppercase tracking-[0.3em] text-[#15122E]/45">
                      Today · 8 hours
                    </span>
                    <span className="font-poppins text-[11px] sm:text-[12px] font-bold uppercase tracking-[0.3em] text-[#15122E]/30">
                      Manual work
                    </span>
                  </div>
                  ...
                  <ul className="mt-4 space-y-2.5">
                    {manualTasks.map((task, index) => (
                      <li key={task.label} className="flex items-start gap-2.5 text-[#15122E]/78 font-['DM_Sans'] text-[14px] sm:text-[15px] leading-relaxed">
                        <span className={"mt-1.5 h-2 w-2 rounded-sm shrink-0 " + task.tone} />
                        <span className={index === manualTasks.length - 1 ? "font-semibold text-[#15122E]" : ""}>
                          {task.label}
                        </span>
                      </li>
                    ))}
                ...
                >
                  <div className="flex items-center justify-between gap-4 mb-3">
                    <span className="font-poppins text-[11px] sm:text-[12px] font-bold uppercase tracking-[0.3em] text-[#6C63FF]">
                      With Nexus agents · 3 hours
                    </span>
                    <span className="font-poppins text-[11px] sm:text-[12px] font-bold uppercase tracking-[0.3em] text-[#6C63FF]/60">
                      Approved work
                    </span>
                  </div>
                  ...
                  <p className="mt-3 font-['DM_Sans'] text-[12px] sm:text-[13px] leading-relaxed text-[#15122E]/45">
