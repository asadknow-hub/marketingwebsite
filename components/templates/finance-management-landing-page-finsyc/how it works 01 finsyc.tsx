            ...
            <div className="w-full flex flex-col gap-6">
              ...
              <div className="w-full">
                <motion.div
                  ...
                  className="w-full bg-white p-4 lg:px-6 lg:py-4 rounded-2xl shadow-[0_1px_20px_0_rgba(21,18,46,0.04)] flex items-center lg:justify-between gap-2 overflow-x-auto overflow-y-hidden scrollbar-hide snap-x"
                >
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isActive ? "bg-white" : "hover:bg-[#F5F3FF]"
                        )}
                      >
                        <step.icon
                          className={cn("w-[22px] h-[22px]", isActive ? "text-[#6C63FF]" : "text-[#15122E]/60")}
                          strokeWidth={2.5}
                        />
                        <span className={cn(
                          "font-inter text-base sm:text-[18px] leading-[28px] whitespace-nowrap",
                          isActive ? "text-[#6C63FF] font-medium" : "text-[#15122E]/60 font-normal"
                        )}>
                          {step.label}
                        </span>
                      </button>
              ...
              {/* Main Content Card */}
              <div className="w-full">
                <div className="w-full bg-white rounded-[32px] border border-[#15122E]/[0.04] shadow-[0_0_20px_0_rgba(21,18,46,0.04)] flex flex-col lg:flex-row items-center justify-between p-6 lg:pt-4 lg:pr-4 lg:pb-4 lg:pl-16 gap-12 lg:gap-0 overflow-hidden">
                  ...
                  <div className="w-full lg:w-[534px] flex flex-col items-start text-left">
                    <motion.div
                      ...
                      className="w-16 h-16 rounded-xl border border-[#15122E]/10 bg-white shadow-sm flex items-center justify-center p-4 mb-3"
                    >
                      <activeStep.icon className="w-8 h-8 text-[#6C63FF]" strokeWidth={2.5} />
                    </motion.div>
                    ...
                    <motion.h3
                      ...
                      transition={{ duration: 0.3 }}
                      className="text-[#15122E] font-onest text-[28px] lg:text-[34px] font-semibold leading-tight lg:leading-[38px] tracking-[-1px] mb-4"
                    >
                      {activeStep.heading}
                    </motion.h3>
                    ...
                    <motion.p
                      ...
                      className="text-[#15122E] font-inter text-base lg:text-[18px] font-normal leading-relaxed lg:leading-[28px] opacity-80 mb-8"
                    >
                    ...
                    <div className="flex flex-col gap-3 mb-12">
                      {activeStep.list.map((item: string, i: number) => (
                        ...
                        >
                          <div className="w-5 h-5 rounded-full bg-[#6C63FF]/10 flex items-center justify-center shrink-0">
                            <Check className="w-3 h-3 text-[#6C63FF] stroke-[3px]" />
                          </div>
                          <span className="text-[#15122E] font-inter text-base font-medium leading-6 tracking-[-0.3px]">
                            {item}
                          </span>
                        </motion.div>
                      ))}
                    ...
                    <motion.button
                      ...
                      layout
                      className={cn(
                        "flex items-center gap-3 py-2 rounded-full bg-[#15122E] group cursor-pointer relative h-14 transition-all duration-300",
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <ArrowUpRight className="w-4 h-4 text-[#15122E]" />
                        </motion.div>
                      </motion.div>
                    </motion.button>
                  </div>
