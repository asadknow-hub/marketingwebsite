          ...
          <div className="w-full max-w-[1248px] mx-auto">
            ...
            <div className="flex flex-col items-center text-center mb-12 md:mb-[80px]">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#6C63FF]/5 border border-[#6C63FF]/10 mb-6"
              >
                <Star className="w-4 h-4 text-[#6C63FF] fill-[#6C63FF]" />
                <span className="text-[#6C63FF] text-[14px] font-medium font-sans">Integrations</span>
              </motion.div>
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                className="text-[32px] sm:text-[40px] md:text-[52px] font-semibold text-[#15122E] leading-[1.2] md:leading-[58px] tracking-tight md:tracking-[-1.8px] mb-6 max-w-2xl text-center"
              >
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="text-[15px] md:text-[18px] text-[#15122E] leading-[1.6] md:leading-[28px] max-w-[612px] font-sans font-normal opacity-80 text-center"
              >
              ...
              >
                <defs>
                  <linearGradient id="line-gradient-left" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#6C63FF" stopOpacity="0.02" />
                  ...
                  return (
                    <React.Fragment key={"path-left-" + i}>
                      <path
                        ...
                        opacity="0.9"
                      />
                      <motion.circle r="3.5" fill="#6C63FF">
                        <animateMotion
                          dur="3.5s"
                ...
                <div className="flex flex-wrap lg:grid justify-center gap-4 lg:absolute lg:left-0 lg:top-0 lg:h-full lg:w-[280px] mb-8 lg:mb-0">
                  {leftIntegrations.map((item, idx) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className={"w-[240px] sm:w-[260px] lg:w-[280px] h-[72px] lg:h-[80px] bg-white rounded-[16px] lg:rounded-[20px] p-3 lg:p-[16px] flex items-center gap-3 lg:gap-4 shadow-[0_4px_20px_rgba(21,18,46,0.02)] group hover:shadow-[0_12px_40px_rgba(21,18,46,0.06)] transition-all cursor-default border border-black/[0.02] lg:absolute"}
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="text-[#15122E] font-semibold text-[14px] lg:text-[16px] leading-tight">{item.name}</span>
                        <span className="text-[#15122E]/40 text-[12px] lg:text-[13px] font-sans mt-0.5">{item.description}</span>
                      </div>
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="flex items-center justify-center py-8 lg:py-0 lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2">
                  <div className="relative w-[100px] lg:w-[124px] h-[100px] lg:h-[124px] flex items-center justify-center">
                    <motion.div
                      ...
                      className="absolute inset-0 -m-8 lg:-m-[58px] rounded-full bg-[#EEECFF]/60 shadow-[inset_0_0_40px_rgba(108,99,255,0.03)]"
                    />
                    ...
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className="w-full h-full rounded-full bg-white shadow-[0_12px_48px_rgba(108,99,255,0.12)] flex items-center justify-center relative z-10"
                    >
                      <div className="w-[84px] lg:w-[104px] h-[84px] lg:h-[104px] rounded-full bg-[#FAF9FF] flex items-center justify-center">
                        <img
            ...
            <div className="flex flex-col items-center mt-12 md:mt-[80px] gap-6 md:gap-8">
              <motion.div
                ...
                viewport={{ once: true }}
                className="inline-flex items-center gap-3 px-5 md:px-[24px] py-2 md:py-[11px] rounded-full border border-[#6C63FF]/15 bg-white/50 shadow-[0_4px_24px_rgba(108,99,255,0.03)]"
              >
                <ShieldCheck className="w-5 h-5 text-[#6C63FF]" />
                <p className="text-[13px] md:text-[15px] font-sans">
                  <span className="text-[#6C63FF] font-semibold">Bank-level security.</span>{" "}
                  <span className="text-[#15122E]/40">Your data is encrypted and never shared.</span>
                </p>
              </motion.div>
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="text-[13px] md:text-[15px] text-[#15122E]/40 font-sans tracking-tight text-center px-4"
              >
                Trusted by{" "}
                <span className="font-semibold text-[#6C63FF]">100,000+</span>{" "}
                users. Connect with{" "}
                <span className="font-semibold text-[#6C63FF]">10,000+</span>{" "}
