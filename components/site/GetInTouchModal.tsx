            ...
            >
              ...
              {status === "submitted" ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="max-w-[470px] pr-12">
                      ...
                      <AnimatePresence>
                        {isDepartmentListOpen && (
                          <motion.div
                            ...
                            exit={{ opacity: 0, y: -6 }}
                            className="absolute left-0 right-0 top-[calc(100%+8px)] z-10 overflow-hidden rounded-2xl border border-[#15122E]/10 bg-white p-2 shadow-[0_16px_45px_rgba(21,18,46,0.14)]"
                          >
                  ...
                  <button
                    ...
                    className="flex h-13 w-full items-center justify-center gap-2 rounded-full bg-[#15122E] px-6 py-3.5 font-poppins text-sm font-semibold text-white transition-colors hover:bg-[#4F46E5] disabled:cursor-not-allowed disabled:opacity-45"
                  >
